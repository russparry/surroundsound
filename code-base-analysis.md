...
**Total Lines of Code:** ~1,330 lines (excluding dependencies)
...
#### **app/room/[code]/page.tsx** (685 lines) ⭐ **LARGEST FILE**
...
|------|-------|----------|------------|
| **app/room/[code]/page.tsx** | 685 | Frontend | ⭐⭐⭐⭐⭐ High |
| **server.js** | 188 | Backend | ⭐⭐⭐⭐ Medium-High |
| **app/page.tsx** | 118 | Frontend | ⭐⭐⭐ Medium |
...
```
Frontend (React/Next.js):    ~1,000 lines (70%)
Backend (Node.js/Socket.io):   ~188 lines (13%)
Utilities/Libraries:           ~106 lines (7%)
State Management:              ~108 lines (8%)
Configuration:                 ~113 lines (8%)
Styling:                        ~19 lines (1%)
```
...
```
TypeScript (.tsx):  ~950 lines  (66%)
JavaScript (.js):   ~188 lines  (13%)
TypeScript (.ts):   ~106 lines  (7%)
Config (.json):     ~113 lines  (8%)
CSS (.css):          ~19 lines  (1%)
```
